...
```javascript
promotionRules = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-promotion-rules@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-promotion-rules@v0.2.1-umd/browser.js"></script>
```
